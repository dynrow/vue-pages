...
//设置默认显示缩放比例
var DEFAULT_JC_ZOOM = window.navigator.userAgent.indexOf('EBEN') > 0 ? 90 : 40;
var MIN_SCALE = 0.25;
var MAX_SCALE = 10.0;
...
var PDFViewerApplication = {
    ...
    zoomIn: function pdfViewZoomIn(ticks, callback) {
    ...
    zoomOut: function pdfViewZoomOut(ticks, callback) {
        var newScale = this.pdfViewer.currentScale;
        do {
            newScale = (newScale / DEFAULT_SCALE_DELTA).toFixed(2);
        ...
        firstPagePromise.then(function (pdfPage) {
            ...
            store.initializedPromise.then(function resolved() {
                ...
                if (self.preferenceShowPreviousViewOnLoad &&
                    ...
                    var zoom = self.preferenceDefaultZoomValue || window.DEFAULT_JC_ZOOM || store.get('zoom', self.pdfViewer.currentScale);
